<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrearUsuarioPacienteLogin.aspx.cs" Inherits="Vistas.CrearUsuarioLogin" %>
...
<body class="container d-flex position-relative bg-info bg-opacity-75" style="max-height: 100%; height: 720px; left: 0px; top: 0px;">
    <form id="form1" runat="server" >
            ...
            <asp:HyperLink ID="HyperLinkVolver" runat="server"  CssClass=" btn btn-light text-decoration-none text-dark  position-absolute  top-0 start-0 mt-2"  Font-Underline="True" ForeColor="Blue" NavigateUrl="~/Ingreso.aspx">Volver a Inicio</asp:HyperLink>
        
        
        <div  class=" w-200 p-3 m border rounded-2 justify-content-center align-items-center bg-light position-absolute top-50
            start-50 translate-middle bg-light bg-light" >
             ...
             <div class="inputsGroup2 w-50 p-3" >
                 <div class=" d-block">
                    <asp:Label ID="Label7" runat="server" CssClass="form-label" Text="Email:"></asp:Label>
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="RequiredFiel_Mail" runat="server" ControlToValidate="txtEmail" ErrorMessage="*Ingrese un email valido"  ValidationGroup="grp1" ForeColor="Red"></asp:RequiredFieldValidator>
               ...
               <div class-="d-block ">
                     <asp:Label ID="Label9" runat="server" CssClass="form-label" Text="Obra Social : "></asp:Label>
                        ...
                        <asp:DropDownList ID="ddlObrasSociales" CssClass=" p-2 rounded-2" runat="server">
                            <asp:ListItem Selected="True">--Seleccionar Covertura--</asp:ListItem>
                        </asp:DropDownList>
                   <br />
